package com.mahesaiqbal.androidsimisimi;
...
import com.mahesaiqbal.androidsimisimi.adapter.CustomAdapter;
import com.mahesaiqbal.androidsimisimi.helper.HttpDataHandler;
import com.mahesaiqbal.androidsimisimi.model.ChatModel;
import com.mahesaiqbal.androidsimisimi.model.SimiSimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class SimiSimiAPI extends AsyncTask<List<ChatModel>,Void,String> {
        ...
        protected String doInBackground(List<ChatModel>... params) {
            String url = String.format("http://sandbox.api.simsimi.com/request.p?key=%s&lc=id&ft=1.0&text=%s",getString(R.string.simisimi_api),text);
            models = params[0];
